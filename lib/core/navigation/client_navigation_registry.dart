...
abstract class ClientNavigationRegistry {
  static const List<ClientMenuItem> items = [
    ...
    // 11. Marketplace & Services (With Submenus)
    ClientMenuItem(
      ...
      badgeCount: 6,
      badgeColor: Color(0xFF10B981),
      description: 'Unified commerce for blueprints, home decor, materials, verified properties, on-demand labour & orders',
      subFeatures: [
        'Digital Products Store (Vastu & BIM Revit Packs)',
        'Curated Home Decor & Designer Lighting',
        'Construction & Interior Materials (B2B Trade Pricing)',
        'Verified Properties & Luxury Rentals (RERA Title Vetted)',
        'On-Demand Guild Labour (Master Carpenters & Electricians)',
        'Unified Orders & Service Appointment Ledger',
      ],
      subItems: [
        ClientSubMenuItem(
          id: 'client_marketplace_overview',
          title: 'Marketplace Home',
          icon: Icons.dashboard_outlined,
          routeName: RouteNames.clientMarketplaceOverview,
          routePath: RouteNames.clientMarketplaceOverviewPath,
          description: 'Platform discovery hub & featured collections',
        ),
        ClientSubMenuItem(
          id: 'client_digital_store',
          title: 'Digital Products',
          icon: Icons.menu_book_rounded,
          routeName: RouteNames.clientMarketplaceDigitalProducts,
          routePath: RouteNames.clientMarketplaceDigitalProductsPath,
          description: 'Vastu blueprints, Revit BIM & BOQ sheets',
        ),
        ClientSubMenuItem(
          id: 'client_decor_store',
          title: 'Home Decor',
          icon: Icons.chair_rounded,
          routeName: RouteNames.clientMarketplaceHomeDecor,
          routePath: RouteNames.clientMarketplaceHomeDecorPath,
          description: 'Curated chandeliers, teak furniture & rugs',
        ),
        ClientSubMenuItem(
          id: 'client_materials',
          title: 'Materials & Supplies',
          icon: Icons.layers_rounded,
          routeName: RouteNames.clientMarketplaceMaterials,
          routePath: RouteNames.clientMarketplaceMaterialsPath,
          description: 'Factory direct trade pricing for cement & tiles',
        ),
        ClientSubMenuItem(
          id: 'client_properties',
          title: 'Properties & Rentals',
          icon: Icons.apartment_rounded,
          routeName: RouteNames.clientMarketplaceProperties,
          routePath: RouteNames.clientMarketplacePropertiesPath,
          description: 'Verified penthouses & luxury villa listings',
        ),
        ClientSubMenuItem(
          id: 'client_hire_labour',
          title: 'Labour & Services',
          icon: Icons.engineering_rounded,
          routeName: RouteNames.clientMarketplaceLabourServices,
          routePath: RouteNames.clientMarketplaceLabourServicesPath,
          description: 'Book verified master carpenters & electricians',
        ),
        ClientSubMenuItem(
          id: 'client_marketplace_orders',
          title: 'My Orders & Ledger',
          icon: Icons.receipt_long_rounded,
          routeName: RouteNames.clientMarketplaceOrders,
          routePath: RouteNames.clientMarketplaceOrdersPath,
          description: 'Live order tracking & GST tax invoices',
        ),
      ],
    ),
