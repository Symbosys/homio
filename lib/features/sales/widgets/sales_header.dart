...
/// Top Header component for Sales & CRM screens with Title, Subtitle, Date filter, and Actions.
class SalesHeader extends StatelessWidget {
  final String title;
  final String subtitle;
  final IconData icon;
  final SalesDateFilter activeFilter;
  final ValueChanged<SalesDateFilter> onFilterChanged;
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<SalesDateFilter>(
          ...
          borderRadius: AppRadius.sm,
          items: SalesDateFilter.values.map((filter) {
            return DropdownMenuItem<SalesDateFilter>(
              value: filter,
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
