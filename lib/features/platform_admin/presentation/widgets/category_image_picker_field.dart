...
class CategoryImagePickerField extends StatefulWidget {
  ...
  const CategoryImagePickerField({
    super.key,
    this.initialUrl,
    this.selectedBytes,
  ...
  @override
  State<CategoryImagePickerField> createState() => _CategoryImagePickerFieldState();
}

class _CategoryImagePickerFieldState extends State<CategoryImagePickerField> {
